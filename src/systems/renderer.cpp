...
void Renderer::onInit() {
    ...
    m_renderPasses.create(RenderMode::Geometry, GAME_SIZE, 7, true);
...
//    });
    ...
    m_renderPasses.render(RenderMode::Geometry, 7);
}
...
//    shader->setInt("uiTex", 3);
    ...
    static enum_t renderModeDisplay = RenderMode::Geometry;
